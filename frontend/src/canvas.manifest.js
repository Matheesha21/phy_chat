export const manifest = {
  screens: {
    ...
    scr_woacsg: { name: "Choose module", route: "/competitions", state: {"step":"module","selectedYear":2}, position: {"x":1560,"y":3800} },
    scr_w314tv: { name: "Applied Electricity quiz", route: "/competitions", state: {"step":"quiz","selectedYear":2,"selectedModuleId":"applied-electricity"}, position: {"x":2960,"y":3800} },
    scr_e39rzb: { name: "Quiz results", route: "/competitions", state: {"step":"complete","selectedYear":2,"selectedModuleId":"applied-electricity"}, position: {"x":4360,"y":3800} },
